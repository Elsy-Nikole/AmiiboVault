...
class AmiiboRepository(
     ...
     */
// Agrega 'suspend' aquí delante de 'fun'
    suspend fun getAmiibosPage(page: Int, pageSize: Int): List<AmiiboEntity> {
        val offset = page * pageSize
        return amiiboDao.getAmiibosPaged(pageSize, offset)
    }

    /**
     * Búsqueda local reactiva.
     * Filtra los amiibos por nombre usando el DAO.
     */
    fun getAmiibos(query: String): Flow<List<AmiiboEntity>> {
